...
a class attribute to track the number of instances, a customizable
print_symbol for string representation, a static method to compare
rectangles by area, and a class method to create a square.
"""
...
class Rectangle:
    ...
    allows customization of the symbol used for string representation,
    provides a static method to compare rectangles by area,
